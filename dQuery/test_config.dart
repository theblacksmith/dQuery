...
class MyHtmlConfiguration extends Configuration {
  /** Whether this is run within dartium layout tests. */
  final bool _isLayoutTest;
  MyHtmlConfiguration(this._isLayoutTest);
...
void useMyHtmlConfiguration([bool isLayoutTest = false]) {
  configure(new MyHtmlConfiguration(isLayoutTest));
}
